...
Register #(3) MP3(.en(mp3_en), .clear(cl_all | reset), .clock,
                  .D(LoadShape), .Q(mp3));

Register #(3) MP2(.en(mp2_en), .clear(cl_all | reset), .clock,
                  .D(LoadShape), .Q(mp2));

Register #(3) MP1(.en(mp1_en), .clear(cl_all | reset), .clock,
                  .D(LoadShape), .Q(mp1));

Register #(3) MP0(.en(mp0_en), .clear(cl_all | reset), .clock,
                  .D(LoadShape), .Q(mp0));
